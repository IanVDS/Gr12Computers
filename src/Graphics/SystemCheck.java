package Graphics;
/*Submission by Ian Van den Steen
 * Oct. 3 2021
 * Mr. Harwood
 */
...
public class SystemCheck extends JFrame {
	...
	void testButtons(){
		...
		/* TODO The switch case was new to me, but I understood it.
		 * 
		 * I have seen the actionListener, getActionCommand, ActionEvent and e 
		 * before, but I don't quite understand it.
		 * 
		 * I added the command .setOpaque(true) because it wasn't letting me see my buttons
		 * colors (I think because I am on a macbook), and it ended up working. 
		 * This command is found when the buttons are initiated.
		 */
	}
}
